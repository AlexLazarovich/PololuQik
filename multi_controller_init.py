...
cntrl1 = PololuQik2s15v9(serial = ser, resetPin = CONTROLER_1_RESET_PIN, multi_device = True)
cntrl2 = PololuQik2s15v9(serial = ser, resetPin = CONTROLER_2_RESET_PIN, multi_device = True)
